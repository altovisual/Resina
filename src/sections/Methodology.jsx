...
const Methodology = () => {
    const points = [
        ...
        "Es una inversión única y tienes acceso ilimitado PARA TODA LA VIDA. Programa con más de 100 clases y con actualizaciones futuras en video de alta definición (HD).",
        ...
        <section className="py-24 bg-black px-4 relative overflow-hidden">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        Hemos desarrollado una <span className="text-white font-bold">Variedad de Técnicas</span> y creamos una capacitación catalogada como una de las más <span className="text-white font-bold">completas del mercado</span>, con 29 módulos y más de 100 clases virtuales.
                    </motion.p>
                </div>
